...
const AboutSection = () => {
  ...
  return (
    <section id="presentation" className="py-16 lg:py-24 bg-background">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              agro-alimentaire (produits laitiers et farines infantiles vendues
              en officine).
            </p>
          </motion.div>
          ...
          >
            <div className="w-full max-w-md h-80 bg-gradient-hero rounded-2xl flex items-center justify-center shadow-2xl">
              <div className="text-center text-white p-8">
                ...
                <h4 className="text-2xl font-bold mb-2">Expertise Médicale</h4>
